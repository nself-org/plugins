...
// InitSchema creates all content-safety tables if they do not already exist.
func (d *DB) InitSchema(ctx context.Context) error {
	_, err := d.Pool.Exec(ctx, `
		CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

		-- Trust-safety: evidence records
		...
		-- Trust-safety: evidence export jobs
