-- Migration 003: Add type, rollout_pct, and stale_after_days columns to np_flags_flags
...
CREATE INDEX IF NOT EXISTS idx_np_ff_flags_type ON np_flags_flags(type);
