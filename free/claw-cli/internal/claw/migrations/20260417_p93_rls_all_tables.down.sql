-- Down migration for 20260417_p93_rls_all_tables.sql
-- Disables RLS and drops user_isolation policies on all affected tables.
-- Safe to run on tables that no longer exist (skips missing tables).
