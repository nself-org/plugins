// Package tui provides the handful of terminal-output helpers the monitor
// plugin needs to reproduce the exact look of `nself monitor` from before
// extraction (CLI-R11).
//
...
// that cmd/monitor.go actually calls: a boxed command header and a
